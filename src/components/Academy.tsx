  ...
  return (
    <section id="academy" className="py-10 sm:py-12 lg:py-16">
      ...
      >
        ...
        <Link href="/academy" className="inline-block text-xs sm:text-sm border border-white/15 rounded-[3px] px-4 sm:px-6 py-2 sm:py-2.5 text-[#F0F0F0]/40 hover:text-[#F0F0F0]/60 hover:border-white/25 transition-colors">
