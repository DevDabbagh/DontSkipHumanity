  ...
  return (
    <section id="read-section" className="py-10 sm:py-12 lg:py-16">
      ...
      >
        ...
        <Link
          href="/read"
          className="mt-6 inline-block text-sm border border-white/15 rounded-[3px] px-6 py-2.5 text-[#F0F0F0]/40 hover:text-[#F0F0F0]/60 hover:border-white/25 transition-colors"
        >
